...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Estados de Reservas | ConfiguroWeb</a>
    ...
    <div id="wrapper">
          ...
          if ($_SESSION['user_role'] == "Usuario") {
            ...
            <li class="nav-item">
              <a class="nav-link" href="kitchen.php">
                ...
                <span>Estado de reservas</span></a>
            </li>
          ';
          }

          if ($_SESSION['user_role'] == "Adminitrador") {
            echo '
            <li class="nav-item">
              <a class="nav-link" href="kitchen.php">
                <i class="fas fa-fw fa-book"></i>
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Content -->
          <h1>Panel Administrativo de los Estados de las reservas</h1>
          <hr>
          <p>Administrar las reservas  que han sido enviadas hasta acá.</p>

          <div class="card mb-3">
            <div class="card-header">
              <i class="far fa-clipboard"></i>
              Listado de Últimas Reservas Recibidas</div>
            <div class="card-body">
