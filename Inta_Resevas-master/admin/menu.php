  ...
  <body id="page-top">
      ...
      <ul class="sidebar navbar-nav">
		...
		<li class="nav-item">
          <a class="nav-link" href="menu.php">
            ...
            <span>Administracion laboratorios</span></a>
        </li>
        <li class="nav-item">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Adminsitracion de laboratorios</li>
          </ol>

          <!-- Page Content -->
          <h1>Administración de los Laboratorios</h1>
          <hr>
          <p>Acá puedes Administrar los diferentes laboratorios, puedes Agregar, Modificar o Eliminar listas de Laboratorios.</p>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form id="additemform" method="POST">
		        ...
		        <div class="form-group">
		            <label class="col-form-label">Tiempo (hrs):</label>
	...
	<div class="modal fade" id="editItemModal" tabindex="-1" role="dialog" aria-labelledby="editItemModalLabel" aria-hidden="true">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title" id="addItemModalLabel">Editar lista de laboratorios</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body">
	        <form id="edititemform" action="edititem.php" method="POST">
		        ...
		        <div class="form-group">
		            <label class="col-form-label">Tiempo (hts)):</label>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="deleteModalLabel">Estás seguro de eliminar esta lista?</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
